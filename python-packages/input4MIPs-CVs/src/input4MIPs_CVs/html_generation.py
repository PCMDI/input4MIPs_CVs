...
def write_db_view_as_html(
    ...
    res_l = [
        ...
        *header_lines,
        ...
        "| <a href='input4MIPs_source-id_CMIP7.html'>Source ID-level view</a>",
        "| <a href='input4MIPs_datasets_CMIP7.html'>Dataset-level view</a>",
        "| <a href='input4MIPs_files_CMIP7.html'>File-level view</a>",
