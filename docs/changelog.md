...
- Added land-use data for the high scenario extension under source ID `UofMD-landState-h-ext-3-1` ([#470](https://github.com/PCMDI/input4MIPs_CVs/pull/470))
...
- Released data with source IDs of the form `IIASA-IAMC-*-ext-1-1-2`
  ...
  these simulations would be of interest to the Forcings Task Team. ([#465](https://github.com/PCMDI/input4MIPs_CVs/pull/465))


## input4MIPs CVs v6.7.50 (2026-08-05)
...
- Added land-use data for the `M` scenario under source ID `UofMD-landState-m-3-1` ([#452](https://github.com/PCMDI/input4MIPs_CVs/pull/452))
...
- Added final solar forcing for future (ScenarioMIP) experiments (`SOLARIS-HEPPA-ScenarioMIP-4-6`) ([#405](https://github.com/PCMDI/input4MIPs_CVs/pull/405))
...
- Added external link to [FuturePop](https://hub.worldpop.org/doi/10.5258/SOTON/WP00849) in the population dataset docs ([#392](https://github.com/PCMDI/input4MIPs_CVs/pull/392))
...
- Added future solar forcing for testing under source ID `SOLARIS-HEPPA-ScenarioMIP-4-6-a002` ([#369](https://github.com/PCMDI/input4MIPs_CVs/pull/369))
...
- Added volcanic future data for CMIP7 ScenarioMIP simulations ([#361](https://github.com/PCMDI/input4MIPs_CVs/pull/361))
