...
For full details on the ozone dataset please see [Ozone concentrations - input4MIPs Controlled Vocabularies (CVs)](https://input4mips-cvs.readthedocs.io/en/latest/dataset-overviews/ozone/)
