...
within the ESGF input4MIPs project page [here](https://metagrid.esgf-west.org/search/input4MIPs).
...
For the DECK simulations in the production phase of CMIP7, use data with the source ID [PCMDI-AMIP-1-1-10](https://metagrid.esgf-west.org/search?project=input4MIPs&versionType=all&activeFacets=%7B%22source_id%22%3A%22PCMDI-AMIP-1-1-10%22%7D)
...
For the DECK simulations in the testing phase of CMIP7, use data with the source ID [PCMDI-AMIP-1-1-9](https://metagrid.esgf-west.org/search?project=input4MIPs&versionType=all&activeFacets=%7B%22source_id%22%3A%22PCMDI-AMIP-1-1-9%22%7D)
