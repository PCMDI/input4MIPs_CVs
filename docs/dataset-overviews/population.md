...
For the CMIP7 phase of CMIP7 (1850-2025), use data with the source ID [PIK-CMIP-1-0-1]
...
The data has the DOI: [To be added].
...
were combined with FuturePop projections based on SSP v3.2 trajectories (not yet released standalone).
