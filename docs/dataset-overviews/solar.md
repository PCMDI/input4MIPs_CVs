...
For the DECK simulations in the production phase of CMIP7, use data with the source ID [SOLARIS-HEPPA-CMIP-4-6](https://metagrid.esgf-west.org/search?project=input4MIPs&versionType=all&activeFacets=%7B%22source_id%22%3A%22SOLARIS-HEPPA-CMIP-4-6%22%7D)
...
For the DECK simulations in the testing phase of CMIP7, use data with the source ID [SOLARIS-HEPPA-CMIP-4-5](https://metagrid.esgf-west.org/search?project=input4MIPs&versionType=all&activeFacets=%7B%22source_id%22%3A%22SOLARIS-HEPPA-CMIP-4-5%22%7D)
...
For the ScenarioMIP simulations in the production phase of CMIP7, use data with the source ID [SOLARIS-HEPPA-ScenarioMIP-4-6](https://metagrid.esgf-west.org/search?project=input4MIPs&versionType=all&activeFacets=%7B%22source_id%22%3A%22SOLARIS-HEPPA-ScenarioMIP-4-6%22%7D)
...
For the ScenarioMIP simulations in the testing phase of CMIP7, use data with the source ID [SOLARIS-HEPPA-ScenarioMIP-4-6-a002](https://metagrid.esgf-west.org/search?project=input4MIPs&versionType=all&activeFacets=%7B%22source_id%22%3A%22SOLARIS-HEPPA-ScenarioMIP-4-6-a002%22%7D)
...
[on the ESGF under the "CMIP6" project and source ID "SOLARIS-HEPPA-3-2"](https://metagrid.esgf-west.org/search?project=input4MIPs&activeFacets=%7B%22mip_era%22%3A%22CMIP6%22%2C%22source_id%22%3A%22SOLARIS-HEPPA-3-2%22%7D).
