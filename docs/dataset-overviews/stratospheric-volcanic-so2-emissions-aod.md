...
For the DECK simulations in the production phase of CMIP7, use data with the source ID [UOEXETER-CMIP-2-2-1](https://metagrid.esgf-west.org/search?project=input4MIPs&versionType=all&activeFacets=%7B%22source_id%22%3A%22UOEXETER-CMIP-2-2-1%22%7D)
...
For the DECK simulations in the testing phase of CMIP7, use data with the source ID [UOEXETER-CMIP-1-3-1](https://metagrid.esgf-west.org/search?project=input4MIPs&versionType=all&activeFacets=%7B%22source_id%22%3A%22UOEXETER-CMIP-1-3-1%22%7D)
...
For the ScenarioMIP simulations in the production phase of CMIP7, use data with the source ID [UOEXETER-ScenarioMIP-2-2-2](https://metagrid.esgf-west.org/search?project=input4MIPs&versionType=all&activeFacets=%7B%22source_id%22%3A%22UOEXETER-ScenarioMIP-2-2-2%22%7D)
