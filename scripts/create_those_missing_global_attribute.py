...
wanted_DDs_collection = {
    "conventions": "Conventions",  # already in Universe ? all terms
    "contact": "contact",  # in Universe DD : freetext
    "region": "region",  # not in Universe DD
    "title": "title",  # in universe DD : freetext
    "tracking_id": "tracking_id",  # already in universe DD
}
